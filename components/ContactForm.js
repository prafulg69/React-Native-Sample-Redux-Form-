...
const ContactComponent = props => {
    ...
    return (
        <View style={{ flex: 1, flexDirection: 'column', margin: 40, justifyContent: 'flex-start', }}>
            <Text style={{ fontSize: 18, fontWeight: 'bold', width: 200, textAlign: 'center', margin: 10 }}>Contact Form</Text>
            <Field name="username" keyboardType="default" label="First Name: " component={renderField} />
            <Field name="username" keyboardType="default" label="Last Name: " component={renderField} />
            <Field name="email" keyboardType="email-address" label="Email: " component={renderField} />
            <Field name="age" keyboardType="numeric" label="Phone: " component={renderField} />
